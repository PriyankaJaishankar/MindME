...
public class MainActivity31 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity31.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtonkl2);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopkl2);
    ...
    private void playAudio() {
        String textToRead = "Schritt 2: Wählen Sie einen beruhigenden Klang oder ein beruhigendes Instrument.";
