...
public class MainActivity17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity17.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtonk4);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopk4);
    ...
    private void playAudio() {
        String textToRead = "Schritt 4: Bleiben Sie präsent und nicht wertend.";
