...
public class MainActivity27 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity27.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtonm2);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopm2);
    ...
    private void playAudio() {
        String textToRead = "Schritt 2: Wählen Sie ein Mantra, das Sie anspricht.";
    ...
    private void navigateToNextPage() {
        ...
        Intent intent = new Intent(MainActivity27.this, MainActivity28.class);
