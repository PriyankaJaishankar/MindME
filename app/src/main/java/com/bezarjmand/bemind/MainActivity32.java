...
public class MainActivity32 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity32.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtonkl3);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopkl3);
    ...
    private void playAudio() {
        String textToRead = "Schritt 3: Machen Sie es sich bequem im Sitzen oder Liegen.";
