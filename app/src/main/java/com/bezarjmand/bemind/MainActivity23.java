...
public class MainActivity23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity23.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtonl2);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopl2);
    ...
    private void playAudio() {
        String textToRead = "Schritt 2: Entwickeln Sie liebevolle Güte sich selbst gegenüber.";
    ...
    private void navigateToNextPage() {
        ...
        Intent intent = new Intent(MainActivity23.this, MainActivity24.class);
