...
public class MainActivity21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity21.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtong4);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopg4);
    ...
    private void playAudio() {
        String textToRead = "Schritt 4: Bleiben Sie präsent und lenken Sie Ihre Aufmerksamkeit sanft zurück, wenn sie abschweift.";
