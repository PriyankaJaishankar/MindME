...
public class MainActivity20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity20.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtong3);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopg3);
    ...
    private void playAudio() {
        String textToRead = "Schritt 3: Gehen Sie langsam und bewusst und konzentrieren Sie sich dabei auf die Empfindungen in Ihren Füßen und Beinen.";
