...
public class MainActivity22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity22.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtong5);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopg5);
        ...
        // Next Übung Button
        Button nextUebungButton = findViewById(R.id.nextButton3);
