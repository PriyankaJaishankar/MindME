...
public class MainActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButton1);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stop1);
    ...
    private void playAudio() {
        String textToRead = "Hier sind die Schritte der Atemübung,Schritt 1: Nehmen Sie eine bequeme Position ein und schließen Sie Ihre Augen.";
