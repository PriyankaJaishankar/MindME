...
public class MainActivity15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity15.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtonk2);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopk2);
    ...
    private void playAudio() {
        String textToRead = "Schritt 2: Scannen Sie Ihren Körper und nehmen Sie die Empfindungen in jedem Teil wahr.";
