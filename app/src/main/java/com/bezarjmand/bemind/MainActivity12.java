...
public class MainActivity12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity12.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButton3);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stop3);
    ...
    private void playAudio() {
        String textToRead = "Schritt 3: Atmen Sie langsam durch den Mund aus und lassen Sie dabei jegliche Anspannung oder Stress los.";
