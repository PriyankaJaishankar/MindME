...
public class MainActivity19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity19.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtong2);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopg2);
    ...
    private void playAudio() {
        String textToRead = "Schritt 2: Stehen Sie achtsam und werden Sie sich Ihres Körpers bewusst.";
