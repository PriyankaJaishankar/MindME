...
public class MainActivity11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity11.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButton2);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stop2);
    ...
    private void playAudio() {
        String textToRead = "Schritt 2.Atmen Sie tief durch die Nase ein und füllen Sie Ihre Lungen mit Luft.";
