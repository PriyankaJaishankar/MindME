...
public class MainActivity24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity24.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtonl3);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopl3);
    ...
    private void playAudio() {
        String textToRead = "Schritt 3: Erweisen Sie einem geliebten Menschen Liebe und Güte.";
