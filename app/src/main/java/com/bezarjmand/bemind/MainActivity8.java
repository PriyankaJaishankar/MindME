...
public class MainActivity8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtonl1);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopl1);
    ...
    private void playAudio() {
        String textToRead = "Hier sind die Schritte der Liebe-Freundlichkeit Meditation,Schritt 1: Finden Sie eine bequeme Position und schließen Sie die Augen.";
    ...
    private void navigateToNextPage() {
        ...
        Intent intent = new Intent(MainActivity8.this, MainActivity23.class);
