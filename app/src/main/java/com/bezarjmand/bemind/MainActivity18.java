...
public class MainActivity18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity18.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtonk5);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopk5);
        ...
        // Next Übung Button
        Button nextUebungButton = findViewById(R.id.nextButton2);
    ...
    private void playAudio() {
        String textToRead = "Schritt 5: Beenden Sie die Übung, indem Sie sich auf Ihren Atem konzentrieren.";
