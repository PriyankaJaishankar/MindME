...
public class MainActivity29 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity29.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtonm4);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopm4);
    ...
    private void playAudio() {
        String textToRead = "Schritt 4: Wiederholen Sie das Mantra leise oder laut und richten Sie dabei Ihre Aufmerksamkeit ";
