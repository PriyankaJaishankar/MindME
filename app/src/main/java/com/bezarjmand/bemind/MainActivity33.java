...
public class MainActivity33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity33.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtonkl4);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopkl4);
    ...
    private void playAudio() {
        String textToRead = "Schritt 4: Schließen Sie die Augen und konzentrieren Sie sich auf das Geräusch.";
    ...
    private void navigateToNextPage() {
        ...
        Intent intent = new Intent(MainActivity33.this, MainActivity34.class);
