...
public class MainActivity25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textToSpeech = new TextToSpeech(MainActivity25.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        // Play Audio Button
        Button playAudioButton = findViewById(R.id.audioButtonl4);
        ...
        // Stop Audio Button
        Button stopAudioButton = findViewById(R.id.stopl4);
    ...
    private void playAudio() {
        String textToRead = "Schritt 4: Erweitern Sie den Kreis der liebevollen Güte, um neutrale und schwierige Menschen einzubeziehen.";
